...
<head>
    ...
    <title>For Coffee <?= $url->getSegment(3) ?> </title>
    <!-- plugins:css -->
...
<body>
    ...
    <span class="brand-text">FOR COFFEE</span>
</a>
<a class="navbar-brand brand-logo-mini" href="../../index.html">
    <span class="brand-text-mini">FC</span>
</a>
    ...
    <ul class="nav">
        <?php if (session()->get('rule') == 0): // Karyawan ?>
            <li class="nav-item <?php if ($url->getSegment(3) == "antrian") { echo "active"; } ?>">
                <a class="nav-link" href="antrian">
                    <i class="menu-icon mdi mdi-chair-school"></i>
                    <span class="menu-title">Antrian</span>
                </a>
            </li>
            <li class="nav-item <?php if ($url->getSegment(3) == "laporan") { echo "active"; } ?>">
                <a class="nav-link" href="laporan">
                    <i class="menu-icon mdi mdi-book-open-page-variant"></i>
                    <span class="menu-title">Laporan</span>
                </a>
            </li>
        <?php elseif (session()->get('rule') == 1): // Admin ?>
            <li class="nav-item <?php if ($url->getSegment(3) == "laporan") { echo "active"; } ?>">
                <a class="nav-link" href="laporan">
                    <i class="menu-icon mdi mdi-book-open-page-variant"></i>
                    <span class="menu-title">Laporan</span>
            ...
            <li class="nav-item <?php if ($url->getSegment(3) == "menu") { echo "active"; } ?>">
        ...
        <?php elseif (session()->get('rule') == 2): // Owner ?>
            <li class="nav-item <?php if ($url->getSegment(3) == "laporan") { echo "active"; } ?>">
                <a class="nav-link" href="laporan">
                    <i class="menu-icon mdi mdi-book-open-page-variant"></i>
                    <span class="menu-title">Laporan</span>
