            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        ...
                        <p>Silahkan Pilih Menu Sesuka hati </p>
                    </li>
                </ul>
                                ...
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <!-- Menambahkan pengecekan deskripsi -->
                                            <p class="card-text"><?= isset($makanan[$i]["deskripsi"]) ? $makanan[$i]["deskripsi"] : 'Deskripsi tidak tersedia' ?></p>
                                ...
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <!-- Menambahkan pengecekan deskripsi -->
                                            <p class="card-text"><?= isset($snack[$i]["deskripsi"]) ? $snack[$i]["deskripsi"] : 'Deskripsi tidak tersedia' ?></p> <!-- Menambahkan pengecekan deskripsi -->
                                ...
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <!-- Menambahkan pengecekan deskripsi -->
                                            <p class="card-text"><?= isset($minumanDingin[$i]["deskripsi"]) ? $minumanDingin[$i]["deskripsi"] : 'Deskripsi tidak tersedia' ?></p>
                                ...
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <!-- Menambahkan pengecekan deskripsi -->
                                            <p class="card-text"><?= isset($minumanPanas[$i]["deskripsi"]) ? $minumanPanas[$i]["deskripsi"] : 'Deskripsi tidak tersedia' ?></p>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-warning" onclick="prosesTransaksi()" id="simpanTransaksi">Pesan Sekarang</button>
            </div>
        </div>
    </div>
</div>
...
<style>
    ...
    #modalKeranjang .modal-dialog {
        max-width: 80%;  /* Set modal to 80% of screen width */
        margin: 1.75rem auto; /* Margin to center modal */
    }

    #modalKeranjang .modal-body {
        max-height: 70vh;  /* Set max height for modal */
        overflow-y: auto;  /* Add scroll if content overflows */
        padding: 1rem;     /* Add padding for spacing */
    }

    #modalKeranjang .table {
        font-size: 14px;   /* Adjust font size of the table */
        margin-bottom: 0;  /* Remove bottom margin from table */
    }

    /* Add custom style to the buttons */
    .btn-warning {
        font-size: 16px;
    }
</style>
    ...
    pesanan[id][2] += 1; // Tambah jumlah pesanan
    tampilkanPesanan();
}

function kurangiJumlah(id) {
    if (pesanan[id][2] > 1) {
        pesanan[id][2] -= 1; // Kurangi jumlah pesanan
    } else {
        hapusPesanan(id); // Jika jumlah menjadi 0, hapus pesanan
    }
    tampilkanPesanan();
}
    ...
    for (let i = 0; i < pesanan.length; i++) {
        isiPesanan += `
            <tr>
                <td>${pesanan[i][1]}</td>
                <td>
                    <button class='btn btn-sm btn-danger' onClick='kurangiJumlah(${i})'>-</button>
                    ${pesanan[i][2]}
                    <button class='btn btn-sm btn-success' onClick='tambahJumlah(${i})'>+</button>
                </td>
                <td>${formatRupiah(pesanan[i][3].toString())}</td>
                <td>${formatRupiah((pesanan[i][2] * pesanan[i][3]).toString())}</td>
                <td><button class='badge badge-danger' onClick='hapusPesanan(${i})'>x</button></td>
            </tr>`;
    }
